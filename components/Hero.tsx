    ...
    <section className="flex items-center justify-center min-h-screen bg-white text-gray-800 px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="text-center md:text-left">
          <h2 className="text-xl md:text-2xl font-bold ">Hello,</h2>
          <h2 className="font-bold text-xl md:text-3xl mb-2">
            {" "}
            I’m Eneje Chimcheberem Shalom
          </h2>
          <h2 className="font-bold text-xl md:text-3xl mb-6">
            {" "}
            a <span className="text-blue-500">Frontend Web Developer</span>
          </h2>
          <p className="text-sm md:text-base max-w-2xl mb-6">
            Frontend Engineer specializing in <strong>React, Next.js, and TypeScript.</strong> I
            build responsive, scalable, and user-focused applications that
            transform ideas into real-world digital solutions.
          </p>
